        ...
        ViewContainer.prototype.render = function () {
            ...
            if (aspectRatio) {
                if (state.availableWidth !== null) {
                    ...
                    // NOTE: why not always use paddingBottom? Causes height oswblesteration (issue 5606)
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        TableRow.prototype.updateSizing = function (isExternalSizingChange) {
            ...
            if (!props.forPrint &&
                ...
                this.setState({
                    // HACK to prevent oswblesterations of events being shown/hidden from max-event-rows
